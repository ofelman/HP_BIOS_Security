...
if ( ($PSBoundParameters.count -eq 0) -or ($help) ) {
    ...
    "`tCreate_EBAM_Payloads.ps1 [-SPM] | [-EBAM] [-CertsPath <path>] [-PayloadsPath <path>] [-h|-help]"
    "`tCreate_EBAM_Payloads.ps1 -SPM                  # To create only SPM payloads"
    "`tCreate_EBAM_Payloads.ps1 -SPM -EBAM            # Create all payloads"
